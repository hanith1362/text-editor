# -*- coding: utf-8 -*-
"""
Created on Sat Nov  7 21:52:15 2020
...
mic_btn.grid(row=0,column=6,padx=2)
...
def mic_func():
    ...
    msg=ttk.Label()
    msg.pack()
    btn = ttk.Button(text="click to speak",command=rec)
    btn.pack()
