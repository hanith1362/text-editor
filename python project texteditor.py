# -*- coding: utf-8 -*-
"""
Created on Mon Nov  2 11:39:18 2020
...
alignright_btn.grid(row=0,column=8,padx=5)                     ##whenever we know that we to fi something at the top, bottom, left, right then we are using pack and when we want to fix something using row and column then we are using grid
